...
This planning-critique phase is model-agnostic. Use the same evidence-based review and artifact-generation contract with any capable repository-aware model.
